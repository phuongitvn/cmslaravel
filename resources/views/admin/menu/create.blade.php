        ...
        <div class="card-body">
            <form method="POST" action="{{ route('admin.menu.store') }}">
                ...
                <div class="py-2">
                    ...
                    <x-admin.form.input id="name" class="{{$errors->has('name') ? 'border-red-400' : ''}}" type="text" name="name" value="{{ old('name') }}" />
                </div>
                ...
                <div class="py-2">
                    ...
                    <x-admin.form.input id="machine_name" class="{{$errors->has('machine_name') ? 'border-red-400' : ''}}" type="text" name="machine_name" value="{{ old('machine_name') }}" />
                </div>

                <div class="py-2">
                    <x-admin.form.label for="description" class="{{$errors->has('description') ? 'text-red-400' : ''}}">{{ __('Description') }}</x-admin.form.label>

                    <x-admin.form.input id="description" class="{{$errors->has('description') ? 'border-red-400' : ''}}" type="text" name="description" value="{{ old('description') }}" />
                </div>
