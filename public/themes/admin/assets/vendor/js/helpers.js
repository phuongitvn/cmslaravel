      ...
      var d = {
              ...
              if (n) {
                  ...
                  if (i) {
                      ...
                      var r = o.scrollTop
                        ...
                        , a = +new Date;
                      !0 === e ? function e() {
                          var n, i, l, u = +new Date - a, c = (n = u,
                          i = r,
                          l = s,
                          (n /= t / 2) < 1 ? l / 2 * n * n + i : -l / 2 * ((n -= 1) * (n - 2) - 1) + i);
                          o.scrollTop = c,
          ...
          _bindLayoutAnimationEndEvent: function(e, t) {
              ...
              this._transitionCallback = function(e) {
                  e.target === i && (n._unbindLayoutAnimationEndEvent(),
                  t.call(n))
              }
              ,
          ...
          _unbindLayoutAnimationEndEvent: function() {
              ...
              t && this._transitionCallback && l.forEach((function(n) {
          ...
          scrollPageTo: function(e) {
              ...
              "number" != typeof e && (e = e.getBoundingClientRect().top + n.scrollTop);
              var i = n.scrollTop
                , o = e - i
                , r = +new Date;
              !function s() {
                  var a, l, u, c = +new Date - r, d = (a = c,
                  l = i,
                  u = o,
                  (a /= t / 2) < 1 ? u / 2 * a * a + l : -u / 2 * ((a -= 1) * (a - 2) - 1) + l);
                  n.scrollTop = d,
          ...
          setContentLayout: function() {
              ...
              setTimeout((function() {
                  ...
                  document.querySelector(".content-wrapper > .menu-horizontal > div") && (f = !0,
                  n = document.querySelector(".content-wrapper > .menu-horizontal > div")),
                  "compact" === t ? (u.some((function(e) {
                      return [i, l].includes(e)
                  }
                  )) && (e._removeClass("container-fluid", [i, l]),
                  e._addClass("container-xxl", [i, l])),
                  a && (e._removeClass("container-fluid", [a]),
                  ...
                  f && (e._removeClass("container-fluid", n),
                  e._addClass("container-xxl", n),
                  r && (e._removeClass("container-fluid", r),
                  e._addClass("container-xxl", r)),
                  s && (e._removeClass("container-fluid", s),
                  e._addClass("container-xxl", s)))) : (c.some((function(e) {
                      return [i, l].includes(e)
                  }
                  )) && (e._removeClass("container-xxl", [i, l]),
                  e._addClass("container-fluid", [i, l])),
                  a && (e._removeClass("container-xxl", [a]),
                  ...
                  f && (e._removeClass("container-xxl", n),
                  e._addClass("container-fluid", n),
                  r && (e._removeClass("container-xxl", r),
                  e._addClass("container-fluid", r)),
                  s && (e._removeClass("container-xxl", s),
          ...
          updateCustomOptionCheck: function(e) {
              e.checked ? ("radio" === e.type && [].slice.call(e.closest(".row").querySelectorAll(".custom-option")).map((function(e) {
              ...
              document.querySelectorAll('[data-bs-toggle="sidebar"]').forEach((function(e) {
                  e.addEventListener("click", (function() {
                      ...
                      document.querySelectorAll(t).forEach((function(e) {
                          ...
                          null != n && !1 !== n && void 0 !== i && (e.classList.contains("show") ? i[0].classList.add("show") : i[0].classList.remove("show"),
