...
function() {
    ...
    var a, t = document.querySelector(".dropdown-style-switcher"), s = localStorage.getItem("templateCustomizer-" + templateName + "--Style") || (window.templateCustomizer?.settings?.defaultStyle ?? "light"), l = (window.templateCustomizer && t && ([].slice.call(t.children[1].querySelectorAll(".dropdown-item")).forEach(function(e) {
    ...
    l = t.querySelector("i"),
    "light" === s ? (l.classList.add("bx-sun"),
    new bootstrap.Tooltip(l,{
        title: "Light Mode",
        fallbackPlacements: ["bottom"]
    })) : "dark" === s ? (l.classList.add("bx-moon"),
    new bootstrap.Tooltip(l,{
        title: "Dark Mode",
        fallbackPlacements: ["bottom"]
        ...
        for (let e = 0; e < i.length; e++)
            i[e].addEventListener("click", function() {
                ...
                i18next.changeLanguage(o, (e,t)=>{
                    if (window.templateCustomizer && window.templateCustomizer.setLang(o),
    ...
    if (u && (window.innerWidth < window.Helpers.LAYOUT_BREAKPOINT ? window.Helpers.setNavbarFixed("fixed") : window.Helpers.setNavbarFixed("")),
...
"undefined" != typeof $ && $(function() {
    ...
    var t, o, e, n = $(".search-toggler"), a = $(".search-input-wrapper"), s = $(".search-input"), l = $(".content-backdrop");
